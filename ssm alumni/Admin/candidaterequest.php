...
<div class="row">
 <div class="col-sm-12">
  <ul class="nav nav-pills">
    <li><a href="#">Home</a></li>
     <li class="active"><a href="candidaterequest.php">Pending</a></li>
  ...
  <div class="col-sm-12">
  <div class="row">
  <div class="page-header"><h3>New Memeber's Request</h3></div>
<div class="table-responsive">
   <table class="table table-bordered ">
    ...
    <tbody>
     ...
     <?php
$i=1;
$qr=mysql_query("select * from registration where status='Under Verification'")or die(mysql_error());
if(mysql_num_rows($qr)>0)
{
	...
	?>
      <tr>
        ...
        <td><button><i class="fa fa-close" style="font-size:24px"></i></button></td>
      </tr>
      <?php $i++; }} ?>
    </tbody>
  </table>
